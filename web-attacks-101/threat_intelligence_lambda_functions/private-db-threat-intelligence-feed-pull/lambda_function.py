...
IAM: Lambda execution role needs s3:GetObject on the bucket/prefix and network access to Postgres
(Neon over TLS for WA101 Fly.io path, or VPC private IP for CA101 EC2 path).
"""
